...
LINES = {
    "infantry": [
        ...
        "three identical foot soldiers in chainmail and open helmets with swords raised, kite shields each painted with a plain red ring",                           # 劍盾步兵
    ...
    "cavalry": [
        ...
        "two identical armored knights on barded horses with lances raised, plain red caparisons over the horses",                                                   # 重裝騎士團
    ...
    "artillery": [
        ...
        "a field cannon with large spoked wooden wheels and a bronze barrel, two identical gunners in plain dark blue uniforms ramming a charge, a pyramid of black iron cannonballs",  # 野戰砲
    ...
    "shield_wall": [
        ...
        "a stone battlement wall segment with a crenellated top and arrow slits, a plain red pennant on a corner pole",                                              # 城垛
    ...
    "trench": [
        ...
        "a water-filled moat segment with stone-lined banks, wooden stakes angled outward from the far bank",                                                        # 護城壕
