...
extends RefCounted
# The whole mutable run state. Schema is the contract in poc-docs/architecture.md —
...
var happiness: int = 70       # 0..100 (start: driver decision, poc-docs/decision-starting-values.md)
var culture: int = 0
var tech: int = 0
