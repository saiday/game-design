# Death does not re-roll a card's innate quality

When a unit dies, its earned growth is wiped and the card returns at level 0 (the institution
survives, the veterans do not), **but its innate three (accuracy, dodge, speed) persist
unchanged.** This looks thematically wrong at first glance, and a future reader will be tempted to
"fix" it so that dead men are replaced by strangers with new stats. **Do not.**
...
The training tradition does not.
