...
# Part 1 — Full-game PoC guidelines (`insignificant-game/`, fulfilled)
...
- **Documentation:** Create `/insignificant-game/doc/difficulty-design.md` detailing the formula. Also, copy this formula in `game-design/` corresponding design docs.
...
# Part 2 — Loop-PoC guide (repo root, closed 2026-06-17)
...
- **2026-07-08** — Merged with the full-game PoC guidelines into this single file (`poc-implementation-guidelines.md`); the loop-PoC guide became Part 2. The root loop-PoC Godot project was removed the same day (git history keeps it); its archived state files live in `doc/loop-poc-archive/`.
