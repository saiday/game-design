...
2. **Buildings & units ×6 eras** — the volume class. Per building line: era N approved sprite
   ...
   fortifications and enemy tiers, 15 lineage lines × 4 seed chains): **eras 1-5 CLOSED
   (era 1: 60 cells after 7 re-roll rounds; era 2: 48 cells after 4 rounds incl. one
   rebuilt e1 root; era 3: 54 of 56 cells after 4 rounds, cavalry rebuilt as a txt2img
   lineage seam, artillery chain 83 + anti_air chain 84 deliberately left unresolved at
   3 clean chains each; era 4: 53 clean of 58 after 4 re-roll rounds, 5 chains closed
   short; era 5: 49 clean of 53 after 2 re-roll rounds, all 15 lines at ≥3 clean,
   archers/enemy_mid/enemy_hard/bomber era-5 rebuilt as txt2img roots), era-6 wave
   pending** (`phase3_units_wave.py` + `phase3_unit_chains.json`, same era-gated
   machinery as buildings; era 6 pending — the final era, all 15 lines active).
