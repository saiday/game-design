...
2. **Buildings & units ×6 eras** — the volume class. Per building line: era N approved sprite
   ...
   fortifications and enemy tiers, 15 lineage lines × 4 seed chains): **era 1 generated,
   round-3 re-rolls awaiting §8 review** (`phase3_units_wave.py` + `phase3_unit_chains.json`,
   same era-gated machinery as buildings; eras 2-6 not started).
