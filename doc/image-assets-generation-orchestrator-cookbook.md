...
2. **Buildings & units ×6 eras** — the volume class. Per building line: era N approved sprite
   ...
   fortifications and enemy tiers, 15 lineage lines × 4 seed chains): **era 1 CLOSED
   (all 60 chain cells §8-clean after 7 re-roll rounds), era-2 wave running**
   (`phase3_units_wave.py` + `phase3_unit_chains.json`, same era-gated machinery as
   buildings; eras 3-6 pending).
